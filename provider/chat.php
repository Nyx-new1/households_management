...
// Verify booking belongs to provider and get customer name
$stmt = $pdo->prepare("
...
<head>
    <meta charset="UTF-8">
    <title>Chat with <?php echo htmlspecialchars($booking['customer_name']); ?> - HomeServe Pro</title>
...
<body>
    <nav class="navbar">
        <div class="container nav-content">
            <a href="dashboard.php" class="logo">HomeServe Pro</a>
            <div class="nav-links">
        ...
        <div class="chat-container">
            <div class="chat-header">
                <div id="participantPhoto" style="width: 40px; height: 40px; background: #e5e7eb; border-radius: 50%; overflow: hidden; display: flex; align-items: center; justify-content: center;">
                    <i class="fas fa-user-circle" style="color: #6b7280; font-size: 1.5rem;"></i>
                </div>
                <div>
                    <h3 style="margin: 0; font-size: 1.1rem;"><?php echo htmlspecialchars($booking['customer_name']); ?></h3>
                    <p style="margin: 0; font-size: 0.8rem; color: var(--text-light);">Customer &bull; Booking #<?php echo $booking_id; ?></p>
                </div>
            </div>
